  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-8 max-w-[390px] mx-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="w-32 h-32 rounded-full border-4 border-[#4A47A3] flex items-center justify-center mb-6 shadow-lg">
          <div className="flex items-center justify-center">
            <span className="text-5xl font-bold text-[#CC0000]">1</span>
          </div>
        </div>
        
        {/* App Name */}
        <h1 className="text-2xl font-bold text-[#4A47A3] mb-2 font-['Poppins']">
          Real Estate No.1
        </h1>
